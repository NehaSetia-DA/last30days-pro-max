...
# Roughly how much page text to keep as the evidence quote.
_QUOTE_CHARS = 400
...
def _mock_extract(url: str) -> dict:
    ...
    quote = (
        ...
        f"page-level detail about agentic web scraping, MCP tooling, and how "
        f"this source positions itself for AI-agent data extraction."
    )
    return {
        "url": url,
        "status": "mock",
